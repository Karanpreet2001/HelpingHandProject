...
<img  className ="newimg" src="https://www.immigration.ca/wp-content/uploads/2020/04/contact_us_279387361-scaled.jpeg" width="80%" height="40%"/>

<div className="container"> <div class=" text-center mt-5 ">
        <h1>Contact Form</h1>
    </div>
    <div className="row ">
                        ...
                        <form id="contact-form" role="form">
                            <div className="controls">
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12"> <input type="submit" class="btn btn-success btn-send pt-2 btn-block " value="Send Message"/> </div>
                                </div>
                            </div>
                        </form>
                    </div>
